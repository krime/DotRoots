...
# set to 0 if you have problems with the updating prompt
set $UPDATINGPROMPT = 1
...
if $COLOUREDPROMPT == 1
  # set prompt \033[1;37m[\033[1;38;5;27mG\033[1;37m]> \033[0m
  # set prompt \033[1;38;5;69m>\033[1;38;5;33m>\033[1;38;5;27m> \033[0m
  # set extended-prompt \w
  set prompt \033[1m\033[38;5;240m>\033[38;5;245m>\033[38;5;250m>\033[38;5;255m> \033[0m
end

define updateprompt
  if ((($prompt_i%7)+7)%7==0)
    set prompt \033[1m\033[38;5;88m>\033[38;5;124m>\033[38;5;160m>\033[38;5;196m> \033[0m
  end
  if ((($prompt_i%7)+7)%7==1)
    # set prompt \033[0;38;5;1m>\033[1;38;5;1m>\033[0;38;5;9m>\033[1;38;5;9m> \033[0m
    #set prompt \033[0;38;5;4m>\033[1;38;5;4m>\033[0;38;5;12m>\033[1;38;5;12m> \033[0m
    set prompt \033[1m\033[38;5;28m>\033[38;5;34m>\033[38;5;40m>\033[38;5;46m> \033[0m
  end
  if ((($prompt_i%7)+7)%7==2)
    #set prompt \033[1m\033[38;5;2m>\033[38;5;2m>\033[38;5;10m>\033[38;5;10m> \033[0m
    set prompt \033[1m\033[38;5;208m>\033[38;5;214m>\033[38;5;220m>\033[38;5;226m> \033[0m
  end
  if ((($prompt_i%7)+7)%7==3)
    #set prompt \033[0;38;5;3m>\033[1;38;5;3m>\033[0;38;5;11m>\033[1;38;5;11m> \033[0m
    #set prompt \033[1m\033[38;5;19m>\033[38;5;21m>\033[38;5;25m>\033[38;5;27m> \033[0m
    set prompt \033[1m\033[38;5;18m>\033[38;5;25m>\033[38;5;32m>\033[38;5;39m> \033[0m
  end
  if ((($prompt_i%7)+7)%7==4)
    #set prompt \033[0;38;5;4m>\033[1;38;5;4m>\033[0;38;5;12m>\033[1;38;5;12m> \033[0m
    set prompt \033[1m\033[38;5;165m>\033[38;5;129m>\033[38;5;93m>\033[38;5;57m> \033[0m
  end
  if ((($prompt_i%7)+7)%7==5)
    # set prompt \033[0;38;5;5m>\033[1;38;5;5m>\033[0;38;5;13m>\033[1;38;5;13m> \033[0m
    #set prompt \033[0;38;5;8m>\033[1;38;5;8m>\033[0;38;5;7m>\033[1;38;5;7m> \033[0m
    set prompt \033[1m\033[38;5;33m>\033[38;5;39m>\033[38;5;45m>\033[38;5;51m> \033[0m
  end
  if ((($prompt_i%7)+7)%7==6)
    #set prompt \033[0;38;5;6m>\033[1;38;5;6m>\033[0;38;5;14m>\033[1;38;5;14m> \033[0m
    set prompt \033[1m\033[38;5;240m>\033[38;5;245m>\033[38;5;250m>\033[38;5;255m> \033[0m
  end
  set $prompt_i++
end
document updateprompt
Change prompt style everytime when stop
end

shell mkfifo /tmp/colorDumpPipe
shell mkfifo /tmp/colorListPipe
shell mkfifo /tmp/colorStopPipe
...
define hook-quit
  shell rm /tmp/colorDumpPipe
  shell rm /tmp/colorListPipe
  shell rm /tmp/colorStopPipe
end
...
define regflagsarm
  printf "     NF <%d>  ZF <%d>  CF <%d>  VF <%d>  QF <%d>", \
         ($cpsr->n & 1), ($cpsr->z & 1), ($cpsr->c & 1), \
         ($cpsr->v & 1), ($cpsr->q & 1)
  printf "  JF <%d>  EF <%d>  AF <%d>  IF <%d>  FF <%d>\n", \
         ($cpsr->j & 1), ($cpsr->e & 1), ($cpsr->a & 1), \
         ($cpsr->i & 1), ($cpsr->f & 1)
end
document regflagsarm

...
hi LineNr ctermfg=15 ctermbg=236 cterm=bold guifg=#84898c guibg=#2a343a gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#252c31 guibg=#252c31 gui=NONE
hi MatchParen ctermfg=180 ctermbg=NONE cterm=inverse guifg=#dda790 guibg=NONE gui=underline
...
hi Function ctermfg=153 ctermbg=NONE cterm=bold guifg=#bcdbff guibg=NONE gui=NONE
...
hi Special ctermfg=180 ctermbg=NONE cterm=NONE guifg=#f0f0f0 guibg=NONE gui=NONE
hi SpecialKey ctermfg=180 ctermbg=23 cterm=NONE guifg=#414e58 guibg=#252c31 gui=NONE
...
hi Type ctermfg=226 ctermbg=NONE cterm=NONE guifg=#b5d8f6 guibg=NONE gui=NONE

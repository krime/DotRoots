...
if !exists("g:DoxygenToolkit_copyTag")
  let g:DoxygenToolkit_copyTag = "@copyright "
endif
...
function! <SID>DoxygenLicenseFunc()
  ...
  exec "normal A".strpart( s:startCommentBlock, 1 )."\<enter>".s:interCommentBlock.substitute( g:DoxygenToolkit_licenseTag, "\<enter>", "\<enter>".s:interCommentBlock, "g" )
...
function! <SID>DoxygenAuthorFunc()
  ...
  exec "normal ".l:insertionMode.s:interCommentTag.printf("%-15s %s", g:DoxygenToolkit_fileTag, l:fileName)
  exec "normal o".s:interCommentTag.printf("%-15s ", g:DoxygenToolkit_briefTag_pre)
  mark d
  exec "normal o".s:interCommentTag.printf("%-15s %s", g:DoxygenToolkit_authorTag , g:DoxygenToolkit_authorName)
  exec "normal o".s:interCommentTag.printf("%-15s %s", g:DoxygenToolkit_versionTag, g:DoxygenToolkit_versionString)
  " let l:date = strftime("%Y-%m-%d")
  if !exists("g:DoxygenToolkit_dateFormatString")
    let g:DoxygenToolkit_dateFormatString = "%Y-%m-%d"
  endif
  let l:date = strftime(g:DoxygenToolkit_dateFormatString)
  exec "normal o".s:interCommentTag.printf("%-15s %s", g:DoxygenToolkit_dateTag   , l:date)
  if !exists("g:DoxygenToolkit_copyrightString")
    let g:DoxygenToolkit_copyrightString = input("Enter version string : ")
  endif
  exec "normal o".s:interCommentTag.printf("%-15s %s", g:DoxygenToolkit_copyTag   , g:DoxygenToolkit_copyrightString)

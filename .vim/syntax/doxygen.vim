...
exe 'syn region doxygenBrief contained start=+[\\@]\([pcbea]\>\|em\>\|ref\>\|link\>\|f\$\|[$\\&<>#]\)\|[^ \t\\@*]+ start=+\(^\s*\)\@<!\*/\@!+ start=+\<\k+ skip=+'.doxygen_end_punctuation.'\S+ end=+'.doxygen_end_punctuation.'+ end=+\(\s*\(\n\s*\*\=\s*\)[@\\]\([pcbea]\>\|em\>\|ref\>\|link\>\|f\$\|[$\\&<>#]\)\@!\)\@=+ contains=doxygenSmallSpecial,doxygenContinueComment,doxygenBriefEndComment,doxygenFindBriefSpecial,doxygenSmallSpecial,@doxygenHtmlGroup,doxygenTODO,doxygenSTEP,doxygenOtherLink,doxygenHyperLink,doxygenHashLink  skipnl nextgroup=doxygenBody'

syn match doxygenBriefEndComment +\*/+ contained

exe 'syn region doxygenBriefL start=+@\k\@!\|[\\@]\([pcbea]\>\|em\>\|ref\>\|link\>\|f\$\|[$\\&<>#]\)\|[^ \t\\@]+ start=+\<+ skip=+'.doxygen_end_punctuation.'\S+ end=+'.doxygen_end_punctuation.'\|$+ contained contains=doxygenSmallSpecial,doxygenHyperLink,doxygenHashLink,doxygenTODO,doxygenSTEP,@doxygenHtmlGroup keepend'

syn region doxygenBriefLine contained start=+\<\k+ end=+\(\n\s*\*\=\s*\([@\\]\([pcbea]\>\|em\>\|ref\>\|link\>\|f\$\|[$\\&<>#]\)\@!\)\|\s*$\)\@=+ contains=doxygenContinueComment,doxygenFindBriefSpecial,doxygenSmallSpecial,@doxygenHtmlGroup,doxygenTODO,doxygenSTEP,doxygenOtherLink,doxygenHyperLink,doxygenHashLink  skipwhite keepend
...
syn region doxygenBody contained start=+.\|$+ matchgroup=doxygenEndComment end=+\*/+re=e-2,me=e-2 contains=doxygenContinueComment,doxygenTODO,doxygenSTEP,doxygenSpecial,doxygenSmallSpecial,doxygenHyperLink,doxygenHashLink,@doxygenHtmlGroup
...
syn keyword doxygenOther contained arg author copyright date deprecated li return see invariant note post pre remarks since test nextgroup=doxygenSpecialMultilineDesc
...
syn cluster cParenGroup remove=doxygenComment,doxygenCommentL,doxygenCommentC
syn cluster cPreProcGroup add=doxygen.*
syn cluster cMultiGroup add=doxygen.*
syn cluster rcParenGroup add=doxygen.*
syn cluster rcParenGroup remove=doxygenComment,doxygenCommentL,doxygenCommentC
...
if !exists("did_doxygen_syntax_inits")
  ...
  fun! s:Doxygen_Hilights()
    ...
    if (exists('g:doxygen_enhanced_color') && g:doxygen_enhanced_color) || (exists('g:doxygen_enhanced_colour') && g:doxygen_enhanced_colour)
      ...
      SynLink doxygenBrief CommentStat
      SynLink doxygenBody Comment
      SynLink doxygenSpecialTypeOnelineDesc CommentStat
      SynLink doxygenBOther SpecialConstant
      SynLink doxygenParam SpecialComment
      SynLink doxygenParamName Underlined
      SynLink doxygenSpecialOnelineDesc CommentStat
      SynLink doxygenSpecialHeading CommentStat
  ...
  SynLink doxygenSTEP                   doxygenHyperLink
  ...
  SynLink doxygenCommentC               Comment
...
if &syntax=='idl'
  syn cluster idlCommentable add=doxygenComment,doxygenCommentL,doxygenCommentC
endif
